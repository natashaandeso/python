...
print('=========================')
# create a ptyhon that prints the even numbers from 50 to 70 using while loop
number = 50
while number <= 70:
    print(number)
    number = number + 2
...
print('=========================')
# below is a decrement example that prnts the multiples of 3 starting from 210 to 150
number =201
while number >= 150:
    print(number)
    number = number - 3
