...
# Aloop is a control structure that allows us to execute a block of code repeatedly until a certain condition is met.
...
print('===========================')
#  create a pyhton program that prints the leap years in betweeen 2000 and 2024
